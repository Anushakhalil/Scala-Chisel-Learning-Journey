...
class Task2 extends Module{
    ...
    val S = Cat(io.instr(31,25),io.instr(11,7),Fill(20,io.instr(31)))

    val U = Cat(io.instr(31,12),Fill(12,io.instr(31)) << zero5bit)

    val B = Cat(Fill(19,io.instr(31)),io.instr(31),io.instr(30,25),io.instr(11,8),io.instr(7),0.U)

    val J = Cat(Fill(11,io.instr(31)),io.instr(30),io.instr(30,21),io.instr(20),io.instr(19,12))
